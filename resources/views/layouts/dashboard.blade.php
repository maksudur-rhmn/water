  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        @if (Auth::user()->role == 1)
          <a href="{{ route('home') }}" class="sl-menu-link @yield('active-home')">
          ...
          <a href="{{ route('faq_index') }}" class="sl-menu-link @yield('active-faq')">
            <div class="sl-menu-item">
              <i class="fa fa-question tx-24"></i>
              <span class="menu-item-label">Faq</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          <a href="{{ route('category.index') }}" class="sl-menu-link @yield('active-category')">
            <div class="sl-menu-item">
              <i class="fa fa-question tx-24"></i>
              <span class="menu-item-label">Category</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          <a href="{{ route('products.index') }}" class="sl-menu-link @yield('active-products')">
            <div class="sl-menu-item">
              <i class="fa fa-question tx-24"></i>
              <span class="menu-item-label">Products</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->
          <a href="{{ route('coupon.index') }}" class="sl-menu-link @yield('active-coupon')">
            <div class="sl-menu-item">
              <i class="fa fa-question tx-24"></i>
