    ...
    <div class="col-md-8 offset-md-2 col-12">
        <div class="search-form">
            <form action="{{ url('/search') }}" method="get">
                ...
                <input type="text" placeholder="Minimum Price" name="min">
                <input type="text" placeholder="Maximum Price" name="max">
...
<div class="fluid-container">
    <div class="row">
        ...
        <div class="col-lg-7 d-none d-lg-block">
            <nav class="mainmenu">
                <ul class="d-flex">
                    <li class="@yield('active-home')"><a href="{{ url('/') }}">Home</a></li>
                    <li class="@yield('active-about')"><a href="{{ url('/about') }}">About</a></li>
                    <li>
                ...
                <li>
                    ...
                    <ul class="cart-wrap dropdown_style">
                      @foreach (cartItems() as $cartItem)
                        <li class="cart-items">
                            <div class="cart-content">
                                <a href="{{ route('products.show', $cartItem->get_product->product_slug) }}">{{ $cartItem->get_product->product_name }}</a>
                                <span>QTY : {{ $cartItem->cart_amount }}</span>
                                <p>${{ $cartItem->get_product->product_price * $cartItem->cart_amount }}</p>
                                <a href="{{ route('cart.delete', $cartItem->id) }}"><i class="fa fa-times"></i></a>
                            </div>
                        </li>
                      @endforeach

                        <li>Subtotol: <span class="pull-right">${{ cartTotal() }}</span></li>
                        <li>
